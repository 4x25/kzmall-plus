/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: dc105d230fc66dfadc5bab8816f4b841)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	AGENT_AUTH_KV: KVNamespace;
	KZ_API_BASE: "https://dgj8.kzmall.cc/index.php";
	APP_ENV: "development" | "production";
	AGENT_API_ENABLED: "true";
	AGENT_CREDENTIAL_ROOT_KEY_V1: string;
	MANAGEMENT_SESSION_ROOT_KEY_V1: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KZ_API_BASE" | "APP_ENV" | "AGENT_API_ENABLED" | "AGENT_CREDENTIAL_ROOT_KEY_V1" | "MANAGEMENT_SESSION_ROOT_KEY_V1">> {}
}
